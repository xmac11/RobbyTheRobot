...
public class Robot extends Sprite /*extends InputAdapter*/ {
    ...
    private void createRobotB2d() {
        ...
        bodyDef.position.set(/*checkpointData.getSpawnLocation()*/ 1900 / PPM, 110 / PPM /*2410 / PPM, 780 / PPM*/); // 32, 160 for starting // 532, 160 for ladder // 800, 384 after ladder //1092, 384 or 1500, 390 for moving platform
